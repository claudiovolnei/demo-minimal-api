...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "Developed by Claudio Volnei - Owner",
        Contact = new OpenApiContact { Name = "Claudio Volnei", Email = "claudio.volnei@outlook.com" },
...
void MapActions(WebApplication app)
{
        ...
        Fornecedor fornecedor) =>
    {
        ...
        return result > 0 ? //Results.Created($"/fornecedor/{fornecedor.Id}", fornecedor) : 
        ...
        Fornecedor fornecedor) =>
    {
        ...
        return result > 0 ? Results.NoContent() :
                            Results.BadRequest("Hove problema ao salvar o registro");
    })
        .ProducesValidationProblem()
